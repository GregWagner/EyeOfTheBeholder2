...
void Intro::init(MediaWrapper* mediaObject)
{
	...
	*/
    ...
    //Setup der Texte
    mLanguage[0].sringData = languageData.mText[12];
    mLanguage[0].from = 369;
    mLanguage[0].to = 426;
    mLanguage[0].row = 0;
    mLanguage[1].sringData = languageData.mText[13];
    mLanguage[1].from = 369;
    mLanguage[1].to = 426;
    mLanguage[1].row = 1;
    mLanguage[2].sringData = languageData.mText[14];
    mLanguage[2].from = 427;
    mLanguage[2].to = 484;
    mLanguage[2].row = 0;
    mLanguage[3].sringData = languageData.mText[15];
    mLanguage[3].from = 486;
    mLanguage[3].to = 543;
    mLanguage[3].row = 0;
    mLanguage[4].sringData = languageData.mText[16];
    mLanguage[4].from = 486;
    mLanguage[4].to = 543;
    mLanguage[4].row = 1;
    mLanguage[5].sringData = languageData.mText[17];
    mLanguage[5].from = 545;
    mLanguage[5].to = 619;
    mLanguage[5].row = 0;
    mLanguage[6].sringData = languageData.mText[18];
    mLanguage[6].from = 632;
    mLanguage[6].to = 683;
    mLanguage[6].row = 0;
    mLanguage[7].sringData = languageData.mText[19];
    mLanguage[7].from = 685;
    mLanguage[7].to = 728;
    mLanguage[7].row = 0;
    mLanguage[8].sringData = languageData.mText[20];
    mLanguage[8].from = 729;
    mLanguage[8].to = 854;
    mLanguage[8].row = 0;
    mLanguage[9].sringData = languageData.mText[21];
    mLanguage[9].from = 946;
    mLanguage[9].to = 1000;
    mLanguage[9].row = 0;
    mLanguage[10].sringData = languageData.mText[22];
    mLanguage[10].from = 1017;
    mLanguage[10].to = 1067;
    mLanguage[10].row = 0;
    mLanguage[11].sringData = languageData.mText[23];
    mLanguage[11].from = 1069;
    mLanguage[11].to = 1116;
    mLanguage[11].row = 0;
    mLanguage[12].sringData = languageData.mText[24];
    mLanguage[12].from = 1069;
    mLanguage[12].to = 1116;
    mLanguage[12].row = 1;
    mLanguage[13].sringData = languageData.mText[25];
    mLanguage[13].from = 1118;
    mLanguage[13].to = 1186;
    mLanguage[13].row = 0;
    mLanguage[14].sringData = languageData.mText[26];
    mLanguage[14].from = 1238;
    mLanguage[14].to = 1277;
    mLanguage[14].row = 0;
    mLanguage[15].sringData = languageData.mText[27];
    mLanguage[15].from = 1289;
    mLanguage[15].to = 1341;
    mLanguage[15].row = 0;
    mLanguage[16].sringData = languageData.mText[28];
    mLanguage[16].from = 1289;
    mLanguage[16].to = 1341;
    mLanguage[16].row = 1;
    mLanguage[17].sringData = languageData.mText[29];
    mLanguage[17].from = 1343;
    mLanguage[17].to = 1409;
    mLanguage[17].row = 0;
    mLanguage[18].sringData = languageData.mText[30];
    mLanguage[18].from = 1411;
    mLanguage[18].to = 1473;
    mLanguage[18].row = 0;
    mLanguage[19].sringData = languageData.mText[31];
    mLanguage[19].from = 1494;
    mLanguage[19].to = 1537;
    mLanguage[19].row = 0;
    mLanguage[20].sringData = languageData.mText[32];
    mLanguage[20].from = 1575;
    mLanguage[20].to = 1628;
    mLanguage[20].row = 0;
    mLanguage[21].sringData = languageData.mText[33];
    mLanguage[21].from = 1629;
    mLanguage[21].to = 1682;
    mLanguage[21].row = 0;
    mLanguage[22].sringData = languageData.mText[34];
    mLanguage[22].from = 1693;
    mLanguage[22].to = 1745;
    mLanguage[22].row = 0;
    mLanguage[23].sringData = languageData.mText[35];
