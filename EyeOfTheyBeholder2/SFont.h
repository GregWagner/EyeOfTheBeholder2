...
SFont_Font* SFont_InitFont (SDL_Surface *Font, int r, int g, int b);
SFont_Font* SFont_InitBigFont (SDL_Surface *Font, int r, int g, int b);
SFont_Font* _SFont_InitFont (SDL_Surface *Font);
...
void SFont_Write(SDL_Surface *Surface, const SFont_Font *Font, int x, int y,
				 const char *text);
void SFont_BigWrite(SDL_Surface *Surface, const SFont_Font *Font, int x, int y,
				 const char *text);
