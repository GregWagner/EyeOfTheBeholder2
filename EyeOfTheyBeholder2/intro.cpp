...
void CIntro::init(MEDIAWrapper* mediaObject)
{
    ...
    sprintf(anim[0].fileName, "%s", "mov/intro_seq0");
    anim[0].frames = 5;
    anim[0].keyFrames[0] = 0;
    anim[0].repeat = 1;
    sprintf(anim[1].fileName, "%s", "mov/intro_seq1");
    anim[1].frames = 3;
    anim[1].keyFrames[0] = 36;
    anim[1].keyFrames[1] = 232;
    anim[1].keyFrames[2] = 539;
    anim[1].repeat = 3;
    sprintf(anim[2].fileName, "%s", "mov/intro_seq2");
    anim[2].frames = 4;
    anim[2].keyFrames[0] = 79;
    anim[2].keyFrames[1] = 249;
    anim[2].repeat = 2;
    sprintf(anim[3].fileName, "%s", "mov/intro_seq3");
    anim[3].frames = 3;
    anim[3].keyFrames[0] = 107;
    anim[3].repeat = 1;
    sprintf(anim[4].fileName, "%s", "mov/intro_seq4");
    anim[4].frames = 4;
    anim[4].keyFrames[0] = 159;
    anim[4].repeat = 1;
    sprintf(anim[5].fileName, "%s", "mov/intro_seq5");
    anim[5].frames = 5;
    ...
    anim[5].repeat = 4;
    sprintf(anim[6].fileName, "%s", "mov/intro_seq6");
    anim[6].frames = 2;
    ...
    anim[6].repeat = 4;
    sprintf(anim[7].fileName, "%s", "mov/intro_seq7");
    anim[7].frames = 4;
    anim[7].keyFrames[0] = 196;
    anim[7].repeat = 1;
    sprintf(anim[8].fileName, "%s", "mov/intro_seq8");
    anim[8].frames = 3;
    anim[8].keyFrames[0] = 229;
    anim[8].repeat = 1;
    sprintf(anim[9].fileName, "%s", "mov/intro_seq9");
    anim[9].frames = 7;
    anim[9].keyFrames[0] = 234;
    anim[9].repeat = 1;
    sprintf(anim[10].fileName, "%s", "mov/intro_seq10");
    anim[10].frames = 5;
    anim[10].keyFrames[0] = 286;
    anim[10].repeat = 1;
    sprintf(anim[11].fileName, "%s", "mov/intro_seq11");
    anim[11].frames = 6;
    anim[11].keyFrames[0] = 349;
    anim[11].repeat = 1;
    sprintf(anim[12].fileName, "%s", "mov/intro_seq12");
    anim[12].frames = 2;
    anim[12].keyFrames[0] = 562;
    anim[12].repeat = 1;
    sprintf(anim[13].fileName, "%s", "mov/intro_seq13");
    anim[13].frames = 1;
    anim[13].keyFrames[0] = 627;
    anim[13].repeat = 1;
    sprintf(anim[14].fileName, "%s", "mov/intro_seq14");
    anim[14].frames = 4;
    anim[14].keyFrames[0] = 675;
    anim[14].repeat = 1;
    sprintf(anim[15].fileName, "%s", "mov/intro_seq15");
    anim[15].frames = 3;
    ...
    anim[15].repeat = 15;
    sprintf(anim[16].fileName, "%s", "mov/intro_seq16");
    anim[16].frames = 3;
    anim[16].keyFrames[0] = 769;
    anim[16].repeat = 1;
    sprintf(anim[17].fileName, "%s", "mov/intro_seq17");
    anim[17].frames = 9;
    ...
    anim[17].repeat = 6;
    sprintf(anim[18].fileName, "%s", "mov/intro_seq18");
    anim[18].frames = 4;
    ...
    anim[18].repeat = 23;
    sprintf(anim[19].fileName, "%s", "mov/intro_seq19");
    anim[19].frames = 4;
    anim[19].keyFrames[0] = 959;
    anim[19].repeat = 1;
    sprintf(anim[20].fileName, "%s", "mov/intro_seq20");
    anim[20].frames = 1;
    anim[20].keyFrames[0] = 1013;
    anim[20].repeat = 1;
    sprintf(anim[21].fileName, "%s", "mov/intro_seq21");
    anim[21].frames = 3;
    ...
    anim[21].repeat = 15;
    sprintf(anim[22].fileName, "%s", "mov/intro_seq22");
    anim[22].frames = 5;
    ...
    anim[22].repeat = 15;
    sprintf(anim[23].fileName, "%s", "mov/intro_seq23");
    anim[23].frames = 3;
    ...
    anim[23].repeat = 7;
    sprintf(anim[24].fileName, "%s", "mov/intro_seq24");
    anim[24].frames = 1;
    anim[24].keyFrames[0] = 1279;
    anim[24].repeat = 1;
    sprintf(anim[25].fileName, "%s", "mov/intro_seq25");
    anim[25].frames = 4;
    ...
    anim[25].repeat = 29;
    sprintf(anim[26].fileName, "%s", "mov/intro_seq26");
    anim[26].frames = 1;
    anim[26].keyFrames[0] = 1494;
    anim[26].repeat = 1;
    sprintf(anim[27].fileName, "%s", "mov/intro_seq27");
    anim[27].frames = 1;
    anim[27].keyFrames[0] = 1539;
    anim[27].repeat = 1;
    sprintf(anim[28].fileName, "%s", "mov/intro_seq28");
    anim[28].frames = 6;
    anim[28].keyFrames[0] = 1548;
    anim[28].repeat = 1;
    sprintf(anim[29].fileName, "%s", "mov/intro_seq29");
    anim[29].frames = 1;
    anim[29].keyFrames[0] = 1575;
    anim[29].repeat = 1;
    sprintf(anim[30].fileName, "%s", "mov/intro_seq30");
    anim[30].frames = 1;
    anim[30].keyFrames[0] = 1703;
    anim[30].repeat = 1;
    sprintf(anim[31].fileName, "%s", "mov/intro_seq31");
    anim[31].frames = 1;
    anim[31].keyFrames[0] = 1801;
    anim[31].repeat = 1;
    sprintf(anim[32].fileName, "%s", "mov/intro_seq32");
    anim[32].frames = 11;
    ...
    anim[32].repeat = 5;
    sprintf(keyframe.fileName, "%s", "mov/intro_keyframes");
    keyframe.frames = 8;
