...
#ifdef WINCE
	#include <mediawrapper_ce.cpp>
#else
	#include <mediawrapper.cpp>
#endif

#include <language.cpp>
#include <intro.cpp>
#include <mazeobjects.cpp>
#include <map.cpp>
#include <char.cpp>
#include <event.cpp>
#include <monster.cpp>
#include <item.cpp>
#include <charmenu.cpp>
...
void C3DEngine::initViewArea()
{
	...
	mediaObject.refresh();
	character[0].init(&mediaObject, gameMap); character[0].menuPos = 0; character[0].charID = 0; character[0].imageID = 0; sprintf(character[0].name, "%s", "SHADUM"); sprintf(character[0].charclass, "%s", "PALADIN"); sprintf(character[0].social, "%s", "LAWFUL GOOD");sprintf(character[0].race, "%s", "HUMAN"); sprintf(character[0].gender, "%s", "MALE"); character[0].hp = character[0].currenthp = 100; character[0].food = character[0].currentfood = 100; character[0].strength = 18; character[0].maxstrength = 80; character[0].intelligence = 9; character[0].wisdom = 16; character[0].dext = 15; character[0].constitution = 17; character[0].charisma = 17; character[0].armorclass = 1; character[0].exp = 69000; character[0].lvl = 6; character[0].arrows = 0; character[0].itemHand[0] = 1; character[0].itemHand[1] = 23;
	character[1].init(&mediaObject, gameMap); character[1].menuPos = 1; character[1].charID = 1; character[1].imageID = 1; sprintf(character[1].name, "%s", "ZORG"); sprintf(character[1].charclass, "%s", "FIGHTER"); sprintf(character[1].social, "%s", "TRUE NEUTRAL");sprintf(character[1].race, "%s", "DWARF"); sprintf(character[1].gender, "%s", "MALE"); character[1].hp = character[1].currenthp = 60; character[1].food = character[1].currentfood = 100; character[1].strength = 18; character[1].maxstrength = 80; character[1].intelligence = 10; character[1].wisdom = 6; character[1].dext = 17; character[1].constitution = 19; character[1].charisma = 3; character[1].armorclass = 0; character[1].exp = 69000; character[1].lvl = 6; character[1].arrows = 0; character[1].itemHand[0] = 1; character[1].itemHand[1] = 23;
	character[2].init(&mediaObject, gameMap); character[2].menuPos = 2; character[2].charID = 2; character[2].imageID = 2; sprintf(character[2].name, "%s", "MERLIN"); sprintf(character[2].charclass, "%s", "CLERIC"); sprintf(character[2].social, "%s", "CHAOTIC GOOD");sprintf(character[2].race, "%s", "HUMAN"); sprintf(character[2].gender, "%s", "MALE"); character[2].hp = character[2].currenthp = 80; character[2].food = character[2].currentfood = 100; character[2].strength = 15; character[2].maxstrength = 80; character[2].intelligence = 18; character[2].wisdom = 10; character[2].dext = 19; character[2].constitution = 11; character[2].charisma = 15; character[2].armorclass = 6; character[2].exp = 69000; character[2].lvl = 7; character[2].arrows = 0; character[2].itemHand[0] = 1; character[2].itemHand[1] = 23;
	character[3].init(&mediaObject, gameMap); character[3].menuPos = 3; character[3].charID = 3; character[3].imageID = 31; sprintf(character[3].name, "%s", "VALERIA"); sprintf(character[3].charclass, "%s", "MAGE"); sprintf(character[3].social, "%s", "GOOD");sprintf(character[3].race, "%s", "ELF"); sprintf(character[3].gender, "%s", "FEMALE"); character[3].hp = character[3].currenthp = 50; character[3].food = character[3].currentfood = 100; character[3].strength = 12; character[3].maxstrength = 80; character[3].intelligence = 11; character[3].wisdom = 18; character[3].dext = 16; character[3].constitution = 16; character[3].charisma = 13; character[3].armorclass = 1; character[3].exp = 69000; character[3].lvl = 7; character[3].arrows = 0; character[3].itemHand[0] = 1; character[3].itemHand[1] = 23;
	...
	*/
	...
	for(short i=0; i<40; i++)
	{
		...
		if(gameMap->item[mapWall][i] > 0 && gameMap->item[mapWall][i] < 112)
		{
			...
			if(gameMap->playerFace == 1 || gameMap->playerFace == 2) left = !left;
